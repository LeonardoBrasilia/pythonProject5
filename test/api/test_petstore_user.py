...
def testar_criar_usuario():
    ...
    resposta = requests.post(  # Faz a requisição, passando:
        ...
        data=open('E:/Users/Léo/PycharmProjects/pythonProject5/test/db/user1.json', 'rb'),  # O body JSON
...
def testar_alterar_usuario():
    ...
    resposta = requests.put(
        url=f'{base_url}/{username}',
        data=open('E:/Users/Léo/PycharmProjects/pythonProject5/test/db/user2.json', 'rb'),
        headers=headers
    )
